...
class TesFlowResult(object):
    def __init__(self):
        ...
        self.group_flow_three_population = None
        self.group_flow_four_population = None
        ...
        # Updated for more than 4 cluster models
    ...
    def write_to_csv(self, csv_file):
        ...
        csv_file.writerow({'Testing Flow': self.testing_flow,
                           'Actual Protocol': self.actual_protocol,
                           'Classification Result': self.classification_result,
                           'Considered Fraction': self.considered_fraction,
                           'Group 1 Fraction': self.group_flow_one_population,
                           'Group 2 Fraction': self.group_flow_two_population,
                           'Group 3 Fraction': self.group_flow_three_population,
                           'Group 4 Fraction': self.group_flow_four_population,
                           'Group 1 label': self.group_one_label,
                           'Group 2 label': self.group_two_label,
                           'Group 3 label': self.group_three_label,
                           'Group 4 label': self.group_four_label,
                           'Number of Flows': self.number_of_flows_train,
...
def testing(test_data, test_labels, consider_all, number_of_clusters, attribute_group_for_clusters):
    ...
    for test_data_row in test_data:
        ...
        inner_index = 1
        for att in attribute_group_for_clusters:
