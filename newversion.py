...
def main_modified(outputfile, number_of_clusters=20, number_of_times=10, consider_all=True, number_of_repetetions=10):
    ...
    for clus in range(10, number_of_clusters, 5):
        for att in ATTRIBUTE_GROUP_LIST:
...
def create_plots():
    ...
    for se in plot_map.keys():
        print('SE')
        figure(index)
        #plt.subplot(nrows, (index%2) + 1, index)
...
if __name__ == '__main__':
    ...
    main_modified(output_file, 150, 50, consider_all, 2)
    #supervised()
